...
required='Dockerfile README.md VERSION compose.yaml quadlet/limnoria.container rootfs/usr/local/bin/limnoria-entrypoint rootfs/usr/local/bin/limnoria-healthcheck'
